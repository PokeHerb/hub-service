...
public class HubModificationServiceImpl implements HubModificationService {
    ...
    @Override
    public Hub modifyHubAddress(Hub hub, String sido, String sigungu, String eupmyeon, String dong, String ri, String street, String buildingNo, String details) {
        // 허브 주소 수정
        hub.changeAddress(sido, sigungu, eupmyeon, dong, ri, street, buildingNo, details, addressToCoordinateConverter, checkAccessHub);
